    ...
    return (
        <div>
            <div className=" mt-20 p-24">
                <h2 className="text-3xl font-extrabold text-center">Update Your Craft</h2>

                <form onSubmit={handlerUpdateCraft}>
                    ...
                    <input type="submit" value="Update Craft" className="btn btn-block mt-8 bg-black text-white" />
                </form>
            </div>
        </div>
    );
