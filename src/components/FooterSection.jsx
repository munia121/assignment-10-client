...
const FooterSection = () => {
    return (
        <footer className="px-4 divide-y lg:mt-52 bg-gray-800 text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    ...
                    <div className='flex items-center'>
                        ...
                        <a className="btn btn-ghost gap-0 text-3xl">Weave<span className="text-[#f08b81]">Wonders</span></a>
                    </div>
                </div>
            ...
            <div className="py-6 text-sm text-center text-gray-400">© Copyright 2024 - All right reserved by ACME Industries Ltd</div>
        </footer>
    );
};
